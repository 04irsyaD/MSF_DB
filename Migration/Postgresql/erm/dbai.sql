...
CREATE TABLE public.ai_attachment (
	id uuid NOT NULL,
	document_name varchar NULL,
	okkai_doc_id varchar NULL,
...
CREATE TABLE public.ai_model_profiles (
	...
	max_tokens int4 DEFAULT 256 NOT NULL,
	timeout_s numeric DEFAULT 25 NOT NULL,
	updated_at timestamptz DEFAULT now() NOT NULL,
	is_active bool DEFAULT true NOT NULL,
	CONSTRAINT ai_model_profiles_pkey PRIMARY KEY (id),
	CONSTRAINT ai_model_profiles_profile_key_key UNIQUE (profile_key)
);
...
CREATE TABLE public.ai_org_aliases (
	id bigserial NOT NULL,
	...
	updated_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT ai_org_aliases_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.config_sync_tables (
	id serial4 NOT NULL,
	table_name varchar(255) NOT NULL,
	is_active bool NOT NULL,
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT config_sync_tables_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.db_scheme (
	...
	created_at timestamptz NULL,
	updated_at timestamptz NULL,
	CONSTRAINT db_scheme_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.global_variabel (
	id serial4 NOT NULL,
	...
	CONSTRAINT global_variabel_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.promt_ai (
	id uuid NOT NULL,
	task varchar(500) NULL,
	promt varchar(500) NULL,
	CONSTRAINT promt_ai_pk PRIMARY KEY (id)
);
...
CREATE TABLE public.scheduler_db_config (
	...
	created_at timestamptz DEFAULT now() NULL,
	updated_at timestamptz NULL,
	CONSTRAINT scheduler_db_config_name_key UNIQUE (name),
	CONSTRAINT scheduler_db_config_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.suggestion_question (
	id uuid NOT NULL,
	...
	updated_at timestamptz NULL,
	sql_query text NULL,
	CONSTRAINT suggestion_question_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.t_businessunit (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"BUID" varchar DEFAULT uuid_generate_v4() NULL,
	"BUCD" varchar NULL,
	"BUNM" varchar NULL,
	"CHGDA" date NULL,
...
CREATE TABLE public.t_chainanalysis (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"CHANID" uuid DEFAULT uuid_generate_v4() NULL,
	"CHANCD" varchar DEFAULT concat('CHAN-', nextval('chain_seq'::regclass)) NULL,
	"CHANNM" varchar NULL,
...
CREATE TABLE public.t_corporaterisk (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	...
	"CRAT" timestamptz(6) DEFAULT CURRENT_TIMESTAMP NULL,
	"CHGDA" date DEFAULT CURRENT_TIMESTAMP NULL,
	"CHGBY" varchar(150) NULL,
	"X1" varchar NULL,
	"X2" varchar NULL,
	"X3" varchar NULL,
...
--- sudah di exexc9te di db

-- Table Triggers / belum di execute di db, karena ada function yang belum dibuat
...
CREATE TABLE public.t_corporaterisktotal (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"ID" uuid DEFAULT uuid_generate_v4() NULL,
	"PRD" date NULL,
...
CREATE TABLE public.t_dup_grisklist (
	"BEGDA" date NULL,
	"ENDDA" date NULL,
	"OBJTV" text NULL,
	"GRILID" uuid NULL,
...
CREATE TABLE public.t_dup_irisklist (
	"BEGDA" date NULL,
	"ENDDA" date NULL,
	"OBJTV" text NULL,
	"IRILID" uuid NULL,
...
CREATE TABLE public.t_gkeylist (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"ID" serial4 NOT NULL,
	"REFCD" varchar NULL,
	...
	"VRSN" int4 NULL,
	"STATCD" varchar NULL,
	CONSTRAINT t_gkeylist_pkey PRIMARY KEY ("ID")
);
...
CREATE TABLE public.t_griskdatabase (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"GRDID" uuid DEFAULT uuid_generate_v4() NULL,
	"RISKCD" varchar NULL,
	"PRD" date NULL,
	"RISK" text NULL,
	"CONCD" varchar NULL,
...
-- Table Triggers
-- belum fi x di db, karena ada function yang belum dibuat
...
CREATE TABLE public.t_griskidentification (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"RIDENID" varchar DEFAULT concat('GRI-', nextval('griskidentification_seq'::regclass)) NULL,
	"OBJTV" text NULL,
	"PRONM" text NULL,
	"RISKCD" varchar NULL,
	"RISK" text NULL,
...
-- Table Triggers
-- belum di execute di db, karena ada function yang belum dibuat
...
CREATE TABLE public.t_grisklist (
	...
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"OBJTV" text NULL,
	"GRILID" uuid DEFAULT uuid_generate_v4() NULL,
	"RISKCD" varchar NULL,
	"RISKSUM" text NULL,
	"CRAT" timestamptz(6) DEFAULT CURRENT_TIMESTAMP NULL,
...
CREATE TABLE public.t_griskmeasurement (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"RIMEAID" varchar DEFAULT concat('GRM-', nextval('griskmeasurement_seq'::regclass)) NULL,
	"RISKCD" varchar NULL,
	"PRD" date NULL,
	"LIHOCD" varchar NULL,
	"LIHOVAL" int4 NULL,
...
CREATE TABLE public.t_grisktreatment (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"RITREID" varchar DEFAULT concat('GRT-', nextval('grisktreatment_seq'::regclass)) NULL,
	"RISKCD" varchar NULL,
	"ADDCON" text NULL,
	"DDLN" date NULL,
	...
	"BEGDA"",""ENDDA"",""RITREID"",""RISKCD"",""ADDCON"",""DDLN"",""BUDG"",""SNBUC" varchar(50) NULL,
...
CREATE TABLE public.t_ikeylist (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"ID" serial4 NOT NULL,
	"REFCD" varchar NULL,
	...
	"VRSN" int4 NULL,
	"STATCD" varchar NULL,
	CONSTRAINT t_ikeylist_pkey PRIMARY KEY ("ID")
);
...
CREATE TABLE public.t_inventor (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"INVID" varchar DEFAULT uuid_generate_v4() NULL,
	"INVNM" varchar NULL,
	"NIK" varchar NULL,
	"BUCD" varchar NULL,
	"SELBY" varchar NULL,
	"SELEML" varchar NULL,
	"APRVDAT" timestamptz(6) NULL,
	"STASS" date NULL,
	"ENASS" date NULL,
	"ISACT" bool NULL,
	"EVID" varchar NULL,
...
CREATE TABLE public.t_iriskdatabase (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"IRDID" uuid DEFAULT uuid_generate_v4() NULL,
	"RISKCD" varchar NULL,
	"INFOCD" varchar NULL,
	"PRD" date NULL,
	"IDASCD" varchar NULL,
...
CREATE TABLE public.t_irisklist (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"OBJTV" text NULL,
...
CREATE TABLE public.t_irisktreatment (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
...
CREATE TABLE public.t_likelihoodvalue (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"LIHOID" uuid DEFAULT uuid_generate_v4() NULL,
	"LIHOCD" varchar DEFAULT concat('LIH-', nextval('likelihood_seq'::regclass)) NOT NULL,
	"LIHOCR" varchar NULL,
	"DESC" text NULL,
	"DATAVAL" varchar NULL,
	"OPTI" text NULL,
	"VAL" int4 NULL,
	"CRAT" timestamptz(6) DEFAULT CURRENT_TIMESTAMP NULL,
	"CHGDA" date NULL,
	"CHGBY" varchar(150) NULL,
	"LIHOCRCD" varchar NULL,
	"X2" varchar NULL,
	"X3" varchar NULL,
	"X4" varchar NULL,
	"X5" varchar NULL,
	"X6" varchar NULL,
	"X7" varchar NULL,
	CONSTRAINT t_likelihoodvalue_pk PRIMARY KEY ("LIHOCD")
);
...
CREATE TABLE public.t_lossevent (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"LOID" uuid DEFAULT uuid_generate_v4() NULL,
	"LOCD" varchar NULL,
	"LOINID" varchar NULL,
	"REPBY" varchar NULL,
	"NIK" varchar NULL,
...
CREATE TABLE public.t_losseventlist (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"LOLID" uuid DEFAULT uuid_generate_v4() NULL,
	"LOCD" varchar NULL,
	"LOTIT" varchar NULL,
	"REPBY" varchar NULL,
	"NIK" varchar NULL,
...
CREATE TABLE public.t_object (
	...
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"ID" uuid DEFAULT uuid_generate_v4() NULL,
	"BUCD" varchar(12) NULL,
	"OTYPE" varchar(12) NULL,
	"STEXT" varchar(36) NULL,
	"LTEXT" varchar(120) NULL,
	"OBJDS" text NULL,
	"CRAT" timestamptz(6) DEFAULT CURRENT_TIMESTAMP NULL,
	"CHGDA" date NULL,
	"CHGBY" varchar(150) DEFAULT 'Jihan'::character varying NULL,
...
CREATE TABLE public.t_performremarks (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"PEREMID" uuid NULL,
	"PEREMCD" varchar NULL,
	"PEREMNM" varchar NULL,
	"PRD" date NULL,
	"RLCD" varchar NULL,
	"CRAT" timestamptz DEFAULT CURRENT_TIMESTAMP NULL,
	"CRBY" varchar NULL,
	"UPAT" timestamptz NULL,
	"CHGDA" date NULL,
	"CHGBY" varchar(150) NULL,
	"X1" varchar NULL,
	"X2" varchar NULL,
...
CREATE TABLE public.t_personal (
	"BEGDA" date NULL,
	"ENDDA" date NULL,
	"PRSNID" varchar NULL,
	...
	"DIVNM" varchar NULL,
	"DIRSPV" varchar NULL,
	"DIRSPVNIK" varchar NULL,
	"DIREK" varchar NULL,
	"SUBDIREK" varchar NULL,
	"X5" varchar NULL,
	"X6" varchar NULL,
	"X7" varchar NULL,
	"FORCE_LOGIN" bool NULL,
	ropoid varchar(50) NULL
);
...
CREATE TABLE public.t_reviewer (
	"BEGDA" date NULL,
	"ENDDA" date NULL,
	"RVWID" varchar NULL,
	"RVWNM" varchar NULL,
...
CREATE TABLE public.t_riskchampion (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"RCHID" varchar DEFAULT uuid_generate_v4() NULL,
	"RCHNM" varchar NULL,
	"NIK" varchar NULL,
	"BUCD" varchar NULL,
	"SELBY" varchar NULL,
...
CREATE TABLE public.t_riskowner (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"ROWID" varchar DEFAULT uuid_generate_v4() NULL,
	"ROWNM" varchar NULL,
	"NIK" varchar NULL,
	"BUCD" varchar NULL,
	"SELBY" varchar NULL,
...
CREATE TABLE public.t_riskregisterstatus (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"ID" uuid DEFAULT uuid_generate_v4() NULL,
	"BUCD" varchar NULL,
	"PRD" date NULL,
	"STATCD" varchar DEFAULT 'HREG-1'::character varying NULL,
	"CRAT" timestamptz(6) DEFAULT CURRENT_TIMESTAMP NULL,
	"CHGDA" date NULL,
	"CHGBY" varchar(150) NULL,
	"VRSN" int4 DEFAULT 1 NULL,
	"SDATE" date DEFAULT CURRENT_DATE NULL,
	"EDATE" date NULL,
	"ISREV" bool DEFAULT false NULL,
	"X5" varchar NULL,
	"X6" varchar NULL,
	"X7" varchar NULL
);
...
CREATE TABLE public.t_riskuniversetotal (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"ID" uuid DEFAULT uuid_generate_v4() NULL,
	"PRD" date NULL,
...
CREATE TABLE public.t_task (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"TSKID" varchar DEFAULT uuid_generate_v4() NULL,
	"EML" varchar NULL,
	"TSKNM" varchar NULL,
	"TSKURL" varchar NULL,
	"STATCD" varchar NULL,
...
CREATE TABLE public.t_trisklist (
	"BEGDA" date DEFAULT CURRENT_DATE NULL,
	"ENDDA" date DEFAULT '2999-01-01'::date NULL,
	"TRILID" uuid DEFAULT uuid_generate_v4() NULL,
	"ADDCON" varchar NULL,
	"TRTCD" varchar NULL,
	"RISKSUM" text NULL,
	"CRAT" timestamptz(6) DEFAULT CURRENT_TIMESTAMP NULL,
	...
	"X7" varchar NULL,
	"PICNIK" varchar NULL,
	"BEGDA"",""ENDDA"",""TRILID"",""ADDCON"",""TRTCD"",""RISKSUM"",""CRAT"",""CHGD" varchar(256) NULL
);
...
CREATE TABLE public.ai_messages (
	...
	metadatas jsonb NULL,
	reply_to_message_id uuid NULL,
	status text DEFAULT 'queued'::text NOT NULL,
	created_at timestamptz(6) DEFAULT now() NOT NULL,
	user_id text NOT NULL,
	stage text NULL,
	updated_at timestamptz(6) DEFAULT now() NULL,
	requery text NULL,
	CONSTRAINT chk_role CHECK ((role = ANY (ARRAY['user'::text, 'assistant'::text, 'system'::text, 'tool'::text]))),
	CONSTRAINT chk_status CHECK ((status = ANY (ARRAY['queued'::text, 'processing'::text, 'done'::text, 'failed'::text, 'cancelled'::text]))),
	CONSTRAINT messages_pkey PRIMARY KEY (id),
	CONSTRAINT fk_conversation FOREIGN KEY (conversation_id) REFERENCES public.ai_conversations(id) ON DELETE CASCADE,
	CONSTRAINT messages_reply_to_message_id_fkey FOREIGN KEY (reply_to_message_id) REFERENCES public.ai_messages(id) ON DELETE CASCADE
);
...
CREATE TABLE public.ai_message_attachments (
	...
	CONSTRAINT ai_message_attachments_message_id_attachment_id_key UNIQUE (message_id, attachment_id),
	CONSTRAINT ai_message_attachments_pkey PRIMARY KEY (id),
	CONSTRAINT ai_message_attachments_attachment_id_fkey FOREIGN KEY (attachment_id) REFERENCES public.ai_attachment(id) ON DELETE CASCADE,
	CONSTRAINT ai_message_attachments_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.ai_messages(id) ON DELETE CASCADE
);
...
-- funtions bang ini dulu baru trigger
